...
<form class="form-signin" action="<?= site()."/update/".$product->id  ?>" method="post" autocomplete="off">
    ...
    <form class="form-signin" action="<?= site()."/register" ?>" method="post" autocomplete="off">
        ...
        <div class="form-group">
            <input value="<?= $product->nome ?>" type="text" name="nome" id="nome" class="form-control" placeholder="Nome do Produto">
        </div>
        ...
        <div class="form-group">
            <input value="<?= $product->preco ?>" type="text" name="preco" id="preco" class="form-control money" placeholder="Preço">
        </div>
        <div class="form-group">
